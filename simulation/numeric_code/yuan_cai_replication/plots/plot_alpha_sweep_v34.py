...
Fixed lambda = 1/n^1.1, divisor = 1 (no division).
"""
...
if __name__ == '__main__':
    ...
    method_names = [
        r'Aniso $\lambda=1/n^{1.1}$',
        r'Iso $\lambda=1/n^{1.1}$',
        r'FPCA $\sqrt{n}$',
    ]
    ...
    fig.suptitle(r'$\lambda=1/n^{1.1}$, no divisor, 1000 test fns',
                 fontsize=13, y=1.0)
    plt.tight_layout(rect=[0, 0.04, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_v34_3cases.pdf'),
