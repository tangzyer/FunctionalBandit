...
if __name__ == '__main__':
    ...
    fig.suptitle(r'$\lambda=1/n^{1.5}$: Aniso $\lambda/(\log n)^3$, Iso $\lambda/(\log n)^3$, 1000 test fns',
                 fontsize=13, y=1.0)
    plt.tight_layout(rect=[0, 0.04, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_v33_3cases.pdf'),
