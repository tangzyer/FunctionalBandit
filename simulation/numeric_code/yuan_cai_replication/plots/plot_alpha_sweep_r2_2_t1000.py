"""Plot alpha sweep for r2=2 with 1000 test functions."""
...
if __name__ == '__main__':
    ...
    for case_name, _ in case_info:
        ...
        for n_val in n_values:
            fname = f'alpha_sweep_{case_name}_n{n_val}_t1000.npz'
    ...
    fig.suptitle(r'Coverage & CI Width, $r_2=2$, 1000 test functions, $n \in \{64, 256, 1024\}$',
                 fontsize=14, y=1.0)
    plt.tight_layout(rect=[0, 0.04, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_r2_2_t1000.pdf'),
