"""Plot Lepski coverage/width for v13 — aligned r2=2, beta decay k^{-4} (C1 satisfied)."""
...
if __name__ == '__main__':
    ...
    case_info = [
        ('aligned_r2_2_beta4', r'Aligned ($r_2=2$, $b_k \sim k^{-4}$, C1 satisfied)'),
    ]
    ...
    for C_a, C_i in C_pairs:
        ...
        fig.suptitle(rf'v13: Aligned $r_2=2$, $b_k \sim k^{{-4}}$ (C1 satisfied) — '
                     rf'Adapt.Trunc: 10-fold CV, $\mu_n / (\log n)^2$',
                     fontsize=11, y=1.0)
        plt.tight_layout(rect=[0, 0.08, 1, 0.97])
        out_name = f'inference_alpha_sweep_v13_beta4_7methods_Ca{C_a}_Ci{C_i}.pdf'
