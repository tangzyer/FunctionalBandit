...
5 methods: Aniso-boot, Aniso-theory, Iso-boot, Iso-theory, FPCA.
Uses v11 data (Lepski selection).
"""
...
if __name__ == '__main__':
    ...
    fig.suptitle(r'Lepski Aniso/Iso (bootstrap \& theory $\kappa$), FPCA, 200 test fns',
                 fontsize=13, y=1.0)
    plt.tight_layout(rect=[0, 0.05, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_v11_3cases.pdf'),
