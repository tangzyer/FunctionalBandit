"""Plot coverage/width for r2=3, normal beta (b_k~k^{-2}), 6 methods, J=n^q."""
...
if __name__ == '__main__':
    ...
    K = 200
    case_name = 'aligned_r2_3'
    case_label = r'Aligned ($r_2=3$, $b_k \sim k^{-2}$)'
    ...
    fig.suptitle(rf'$r_2=3$, $b_k \sim k^{{-2}}$ (C1 NOT satisfied), $J=n^q$',
                 fontsize=11, y=1.0)
    plt.tight_layout(rect=[0, 0.06, 1, 0.97])
    out_name = 'inference_r2_3_normal_6m.pdf'
