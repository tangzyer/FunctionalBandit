...
Fixed lambda = 1/n^1.1, divisor = 1000.
"""
...
if __name__ == '__main__':
    ...
    fig.suptitle(r'$\lambda=1/n^{1.1}$: Aniso \& Iso $\lambda/1000$, 1000 test fns',
                 fontsize=13, y=1.0)
    plt.tight_layout(rect=[0, 0.04, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_v39_3cases.pdf'),
