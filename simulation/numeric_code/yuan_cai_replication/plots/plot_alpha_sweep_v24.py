...
if __name__ == '__main__':
    ...
    fig.suptitle(r'Aniso $\lambda/(\log n)^5$, Iso $\lambda/(\log n\,\log\log n)$, grid $[10^{-12},1]$, 1000 test fns',
                 fontsize=13, y=1.0)
    plt.tight_layout(rect=[0, 0.04, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_v24_3cases.pdf'),
