"""Plot Lepski coverage/width for v13 — r2=3, beta~k^{-4}, 6 methods."""
...
if __name__ == '__main__':
    ...
    case_info = [
        ('aligned_r2_3_beta4', r'Aligned ($r_2=3$, $b_k \sim k^{-4}$)'),
    ]
    n_values = [1000, 2000, 4000, 20000]
    ...
    group_starts = {1000: 1, 2000: 5, 4000: 9, 20000: 13}
    x_positions = {}
    ...
    for C_a, C_i in C_pairs:
        ...
        fig, axes = plt.subplots(2, n_cols, figsize=(11, 9))
        if n_cols == 1:
        ...
        fig.suptitle(rf'$r_2=3$, $b_k \sim k^{{-4}}$ (C1 satisfied): '
                     rf'Trunc $5n^q$ + Adapt.Trunc $5n^{{0.2}}$ (CV, $\mu_n/(\log n)^2$)',
                     fontsize=10, y=1.0)
        plt.tight_layout(rect=[0, 0.08, 1, 0.97])
        out_name = f'inference_alpha_sweep_v13_r2_3_beta4_6m_Ca{C_a}_Ci{C_i}.pdf'
