...
if __name__ == '__main__':
    ...
    fig.suptitle(r'5-fold CV $\lambda$: Aniso $\lambda/(\log n)^4$, Iso $\lambda/\log n$, grid $[10^{-12},1]$, 1000 test fns',
                 fontsize=13, y=1.0)
    plt.tight_layout(rect=[0, 0.04, 1, 0.97])
    plt.savefig(os.path.join(results_dir, 'inference_alpha_sweep_v29_3cases.pdf'),
