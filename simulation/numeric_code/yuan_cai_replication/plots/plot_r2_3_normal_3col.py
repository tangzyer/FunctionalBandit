"""Plot coverage/width for normal beta (b_k~k^{-2}), 6 methods, J=n^q.
...
if __name__ == '__main__':
    ...
    fig.suptitle(rf'$b_k \sim k^{{-2}}$ (C1 NOT satisfied), $J=n^q$',
                 fontsize=12, y=1.0)
    plt.tight_layout(rect=[0, 0.06, 1, 0.97])
    out_name = 'inference_normal_3col_6m.pdf'
