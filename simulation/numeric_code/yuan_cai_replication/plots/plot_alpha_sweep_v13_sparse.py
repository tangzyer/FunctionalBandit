"""Plot Lepski coverage/width for v13 — aligned r2=2, sparse beta (C1 satisfied)."""
...
if __name__ == '__main__':
    ...
    case_info = [
        ('aligned_r2_2_sparse', r'Aligned ($r_2=2$, sparse $\beta$, C1 satisfied)'),
    ]
    ...
    for C_a, C_i in C_pairs:
        ...
        fig.suptitle(rf'v13: Sparse $\beta = (4, 0, -2, 0, 1, 0, \ldots)$, $r_2=2$ (C1 satisfied) — '
                     rf'Adapt: CV, $\mu_n / (\log n)^2$',
                     fontsize=11, y=1.0)
        plt.tight_layout(rect=[0, 0.08, 1, 0.97])
        out_name = f'inference_alpha_sweep_v13_sparse_7methods_Ca{C_a}_Ci{C_i}.pdf'
