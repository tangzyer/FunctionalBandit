"""Plot Lepski coverage/width for v13 — r2=3, 6 methods."""
...
if __name__ == '__main__':
    ...
    for C_a, C_i in C_pairs:
        ...
        fig.suptitle(rf'v13 $r_2=3$: Lepski ($C_A={C_a}$, $C_I={C_i}$) '
                     rf'+ Trunc $5n^q$ + Adapt.Trunc $5n^{{0.2}}$ (CV, $\mu_n/(\log n)^2$)',
                     fontsize=10, y=1.0)
        plt.tight_layout(rect=[0, 0.08, 1, 0.97])
        out_name = f'inference_alpha_sweep_v13_r2_3_6m_Ca{C_a}_Ci{C_i}.pdf'
